...
def authenticate_with_username(password: str, username: str, request: HttpRequest | None = None) -> User:
...
def authenticate_with_email(password: str, email: str, request: HttpRequest | None = None) -> User:
    try:
